...
public enum OpCode {
    ...
    PLAYER_DISCONNECTED(22 , "PLAYER_DISCONNECTED"),
    PLAYER_RECONNECTING(23 , "PLAYER_RECONNECTING"),
    PLAYER_RECONNECTED(24 , "PLAYER_RECONNECTED"),
    RECONNECT_REQUEST(25 , "RECONNECT_REQUEST"),
    RECONNECT_OK(26 , "RECONNECT_OK"),
    RECONNECT_FAIL(27 , "RECONNECT_FAIL"),
    GAME_PAUSED(28 , "GAME_PAUSED"),
    GAME_RESUMED(29 , "GAME_RESUMED"),
    ERROR(500, "ERROR");
